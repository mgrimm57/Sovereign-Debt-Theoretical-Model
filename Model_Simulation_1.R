...
### graph
ggplot(results) + geom_line(aes(t,min), linetype="dashed") + geom_line(aes(t,max), linetype="dashed")+ 
  geom_point(aes(t,x_l),color="red") + theme_bw() + 
  geom_line(aes(t,mu), color = "green", linetype="dashed")+
  geom_line(aes(t,p), color="blue") + xlim(2,n) + labs(x="Lending Periods", y= "x")
